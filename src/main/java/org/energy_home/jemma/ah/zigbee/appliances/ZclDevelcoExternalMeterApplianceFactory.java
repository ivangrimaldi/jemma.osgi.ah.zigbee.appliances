...
public class ZclDevelcoExternalMeterApplianceFactory extends DriverApplianceFactory implements Driver {
	public static final String APPLIANCE_TYPE = "org.energy_home.jemma.ah.zigbee.metering.external";
	public static final String APPLIANCE_FRIENDLY_NAME = "Develco External Meter";
	...
	public Appliance getInstance(String pid, Dictionary config) throws ApplianceException {
		return new DevelcoExternalMeterAppliance(pid, config);
	}

	public String deviceMatchFilterString() {
		return "(&(DEVICE_CATEGORY=ZigBee)(zigbee.device.device.id=7)(zigbee.device.manufacturer.id=0))";
	}
}
