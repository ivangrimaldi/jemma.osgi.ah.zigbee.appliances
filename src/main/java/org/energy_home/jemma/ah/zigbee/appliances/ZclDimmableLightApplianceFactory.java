...
public class ZclDimmableLightApplianceFactory extends DriverApplianceFactory implements Driver {
	public static final String APPLIANCE_TYPE = "org.energy_home.jemma.ah.zigbee.dimmablelight";
	public static final String APPLIANCE_FRIENDLY_NAME = "DimmableLight";
	...
	public Appliance getInstance(String pid, Dictionary config) throws ApplianceException {
		return new ZclDimmableLightAppliance(pid, config);
	}

	public String deviceMatchFilterString() {
		return "(&(DEVICE_CATEGORY=ZigBee)(zigbee.device.device.id=1284)))";
	}
}
